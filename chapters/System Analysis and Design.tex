...
\begin{itemize}
    \item \textbf{Platform Compatibility:} The application must be compatible with Android 13 (API level 33) and above, as well as iOS 17 and above.
...
\begin{itemize}
    ...
    \item \textbf{Customer Module:} Features route planning, interactive seat mapping, and generation of the boarding pass.
    \item \textbf{Operator Module:} Fetches enterprise-level metrics to render bookings and financial revenue on specialised dashboards.
    \item \textbf{Tracking and Delivery Module:} Interfaces with map SDKs to parse and display real-time coordinate updates for vehicles.
\end{itemize}
