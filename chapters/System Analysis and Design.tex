...
\begin{figure}[h]
\centering
\includesvg[width=0.85\textwidth]{images/FYP/traxis_use_case_diagram.svg}
...
\begin{figure}[h]
\centering
\includesvg[width=0.80\textwidth]{images/FYP/traxis_level0_context_diagram.svg}
...
\begin{figure}[h]
\centering
\includesvg[width=0.85\textwidth]{images/FYP/traxis_level1_context_diagram.svg}
...
\begin{figure}[h]
\centering
\includesvg[width=0.80\textwidth]{images/FYP/traxis_module_directory_structure.svg}
